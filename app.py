...
#os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = 'C:/Users/priya/Downloads/HW5_SHAH/src/LSTM-forecast/lstm-1-369118-241dfc6235b7.json'
# Initilize flask app
app = Flask(__name__)
...
def forecast():
    ...
    #    'BASE_IMAGE_PATH', 'https://storage.googleapis.com/lstm-1/')
